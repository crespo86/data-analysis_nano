    ...
    with open(filename, "r") as f:
        ...
        for line in reader:
            if line['binomialAuthority_label'] != "NULL":
                if re.search(r'(\([A-Za-z]+\))', line["rdf-schema#label"]):
                    data[re.search(r'(([A-Za-z]+))', line["rdf-schema#label"]).group()] = line['binomialAuthority_label']
                else:
